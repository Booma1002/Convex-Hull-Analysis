# Project: Convex Hull Analysis
### Given a set of points P = {p1, p2, ..., pn} in a 2D plane, finding the subset of points that form the vertices of the convex polygon enclosing all points in P.
